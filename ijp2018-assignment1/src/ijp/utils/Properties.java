 ...
 * <li><code>my.properties</code> (eg. in a user jar file).</li>
 * <li><code>my.properties</code> in the <i>user.dir</i><code>/src</code> directory (eg. Eclipse source directory).</li>
 * <li><code>my.properties</code> in the <i>user.dir</i> directory (eg. BlueJ project directory).</li>
 * <li>in the colon-separated list of files given by the <code>IJP1_PROPERTYPATH</code> environment variable.</li>
 *
 * </ul>
...
public class Properties {
	...
	private static final String propertyFileEnvVar = "IJP1_PROPERTYPATH";
	private static final String defPropFileName = "default.properties";
	private static final String propFileName = "my.properties";
