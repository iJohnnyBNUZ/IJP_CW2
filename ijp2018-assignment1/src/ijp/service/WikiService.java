...
public class WikiService implements Service {
	...
	private static String wikiURLString = "https://en.wikipedia.org/w/api.php";
    ...
    private String requestInfo = "pageimages";
    private String requestPhoto = "imageinfo";
	 ...
	 */
    public WikiService() {
    	this.debugging = Properties.getBool("WikiService.debug");
    }
    ...
    public Picture getPicture(String subject, int index) {
    	...
    	try {
    		...
    		String urlInfo = wikiURLString
    				...
    				+ "&titles=" + URLEncoder.encode(subject, "utf-8");
    		...
    		try {
    			...
    			String urlPhoto = wikiURLString
        				...
        				+ "&titles=" + URLEncoder.encode(this.photoName, "utf-8")
        				+ "&iiprop=" + this.info;
    		...
    		if (debugging) {
    			System.err.println("[debug] WikiService: fetching photo: " + photoURL.toString());
    		}
